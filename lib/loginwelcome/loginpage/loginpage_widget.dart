                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '5a65t952' /* Sign In/Create Account */,
                        ),
                        style:
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'b75061xm' /* Use the account below to sign ... */,
                        ),
                        style:
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.goNamedAuth(
                                  SelectyearWidget.routeName, context.mounted);
                            },
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(NowmainloginWidget.routeName);
                        },
                        text: FFLocalizations.of(context).getText(
                          'e565qqlq' /* Create Acoount */,
                        ),
                        options: FFButtonOptions(
                          width: 228.0,
                          height: 45.0,
