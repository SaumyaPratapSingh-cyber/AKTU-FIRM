...
import 'selectyear_model.dart';
export 'selectyear_model.dart';

class SelectyearWidget extends StatefulWidget {
  const SelectyearWidget({super.key});

  static String routeName = 'selectyear';
  static String routePath = '/selectyear';
        ...
        appBar: AppBar(
          ...
          title: Align(
            ...
            child: AnimatedDefaultTextStyle(
              ...
              duration: Duration(milliseconds: 1545),
              curve: Curves.linear,
              child: Text(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'ogbehysw' /* Access All Your Study Material */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                ...
                child: Stack(
                  children: [
                    Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed(AichatbotWidget.routeName);
                        },
                        text: FFLocalizations.of(context).getText(
                          'gfasx01f' /* Ask to AKTU FIRM  AI */,
                        ),
                        options: FFButtonOptions(
                          width: 300.0,
                          height: 60.0,
