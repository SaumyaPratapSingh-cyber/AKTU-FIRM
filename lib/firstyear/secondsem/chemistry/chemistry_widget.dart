                    ...
                    child: TabBarView(
                      ...
                      children: [
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/CHEMISTRY_PYQ.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/CHEMISTRY_NOTES.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await launchURL(
                                  'https://drive.google.com/file/d/1JbvwReuX3phGTNSomawH_PGD5gYTimjr/view?usp=sharing');
                            },
                            text: FFLocalizations.of(context).getText(
                              'pnri8wkj' /* Click Me */,
                            ),
