...
class PhysicsWidget extends StatefulWidget {
  ...
  static String routePath = '/physics';
                    ...
                    child: TabBarView(
                      ...
                      children: [
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/PHYSICS_PYQ.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/PHYSICS_NOTES.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await launchURL(
                                  'https://drive.google.com/file/d/1JgXUBQ6j1-56o15lTXmEuuE8fuzKqjOX/view?usp=sharing');
                            },
                            text: FFLocalizations.of(context).getText(
                              'lj0ezel2' /* Click Me */,
                            ),
