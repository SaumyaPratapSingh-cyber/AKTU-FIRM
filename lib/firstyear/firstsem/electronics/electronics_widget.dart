                    ...
                    child: TabBarView(
                      ...
                      children: [
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/ELECTRONICS_PYQ.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        FlutterFlowPdfViewer(
                          assetPath: 'assets/pdfs/ELECTRONICS_NOTES.pdf',
                          height: 300.0,
                          horizontalScroll: false,
                        ),
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await launchURL(
                                  'https://drive.google.com/file/d/1Jv7S448ovacXR6PW-6BltjDw3mb0G2pe/view?usp=sharing');
                            },
                            text: FFLocalizations.of(context).getText(
                              'pk0uscv8' /* Click Me */,
                            ),
